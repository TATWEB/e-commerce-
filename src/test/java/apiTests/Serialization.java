...
public class Serialization {
    ...
    public void serializationUsingMaps() {
        ...
        given().
                ...
                //Rest assured has built in Serializers (Object mappers) and you can specify it along with your body
                // body(videogame, ObjectMapperType.JACKSON_2).
                        body(videogame).  // Java object (Map) is going to be serialized and sent across the network
       when().log().all().
                post("/videogames").
       then().log().all().
                assertThat().
    ...
    public void serializationUsingPOJOS() {
        ...
        // POJO -> Plain Old Java Object (or the Object that is created out the Java class)
