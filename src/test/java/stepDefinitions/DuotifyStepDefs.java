...
public class DuotifyStepDefs {
    ...
    @Then("The data base should also have the correct info")
    ...
    public void theUserEmailUpdateShouldBeCorrectlyWithinTheDatabase() {
    ...
    @When("I update username {string} email to {string}")
    public void iUpdateUsernameEmailTo(String username, String updatedEmail) throws SQLException {
    ...
    public void iShouldSeeTheUpdatedEmailOnTheURL() throws InterruptedException {
    ...
    public void iUpdateTheNameColumnWithUnicodeCharsTheUpdateShouldBeSuccessful() throws SQLException {

        expectedDB = "晶明秋亜希亜樹亜紀";
    ...
    public void theUpdateShouldBeAlsoSuccessfulOnTheUI() {
        ...
        Driver.getDriver().navigate().refresh();  // get a fresh reference, to avoid StaleElement Reference Exception
...
// ___________________________________________________
    ...
    // Verifying that the data that we pass are without spaces
    ...
    @Then("The data base should also have the correct info without spaces")
    ...
    public void iSendAQueryToCheckTheUsernames() {
    ...
    public void theReturnedResultListShouldBeEmpty() {
       Assert.assertTrue("The list is not empty and size is: "+ queryResultAsListOfLists.size(), queryResultAsListOfLists.isEmpty());
    }
}
